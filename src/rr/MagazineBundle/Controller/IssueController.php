...
use rr\MagazineBundle\Entity\Issue;
use rr\MagazineBundle\Form\IssueType;
...
class IssueController extends Controller
{
    ...
    public function indexAction()
    {
        ...
        $entities = $em->getRepository('rrMagazineBundle:Issue')->findAll();
     ...
     * @Method("POST")
     * @Template("rrMagazineBundle:Issue:new.html.twig")
     */
    ...
    public function showAction($id)
    {
        ...
        $entity = $em->getRepository('rrMagazineBundle:Issue')->find($id);
    ...
    */
     ...
     * @Method("PUT")
     * @Template("rrMagazineBundle:Issue:edit.html.twig")
     */
